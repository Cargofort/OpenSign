...
import { appName, smtpenable, smtpsecure, updateMailCount, renderBrandedEmailHtml } from '../../Utils.js';
...
async function sendMailProvider(params) {
  ...
  const html =
    params?.applyBranding && params?.html
      ? await renderBrandedEmailHtml({
          htmlBody: params.html,
          headerText: params?.brandingHeader || '',
          footerText: params?.brandingFooter || '',
        })
      : params?.html || '';
